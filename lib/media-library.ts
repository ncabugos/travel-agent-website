...
export const HOTEL_LOGOS = {
  ...
  belmondBelliniClub:         m('/media/hotel-programs/logos/belmond-bellini-club.png'),
  dorchesterDiamondClub:      m('/media/hotel-programs/logos/dorchester-diamond-club.png'),
  fourSeasonsPreferred:       m('/media/hotel-programs/logos/four-seasons-preferred-partner.png'),
  hyattPrive:                 m('/media/hotel-programs/logos/hyatt-prive.png'),
  hyattPriveWhite:            m('/media/hotel-programs/logos/hyatt-prive-white.png'),
  mandarinFanClub:            m('/media/hotel-programs/logos/mandarin-oriental-fan-club.png'),
  peninsulaPenClub:           m('/media/hotel-programs/logos/peninsula-pen-club.png'),
  ritzCarltonStars:           m('/media/hotel-programs/logos/ritz-carlton-stars.png'),
  roccoForte:                 m('/media/hotel-programs/logos/rocco-forte-hotels.png'),
  rosewoodElite:              m('/media/hotel-programs/logos/rosewood-elite.png'),
  shangriLaLuxuryCircle:      m('/media/hotel-programs/logos/shangri-la-luxury-circle.png'),
  kempinskiClub1897:          m('/media/hotel-programs/logos/kempinski-club1897.png'),
  oetkerPearl:                m('/media/hotel-programs/logos/oetker-pearl.png'),

  // Brand programmes (colour logos)
  aman:                       m('/media/hotel-programs/logos/aman.png'),
  aubergeResorts:             m('/media/hotel-programs/logos/auberge-resorts.png'),
  comoHotels:                 m('/media/hotel-programs/logos/como-hotels.png'),
  montage:                    m('/media/hotel-programs/logos/montage-hotels.png'),
  oneAndOnly:                 m('/media/hotel-programs/logos/one-and-only.png'),

  // Global networks (colour logos)
  accorHera:                  m('/media/hotel-programs/logos/accor-hera.png'),
  marriottLuminous:           m('/media/hotel-programs/logos/marriott-luminous.png'),
  leadingHotels:              m('/media/suppliers/logos/leading-hotels-black-600.png'),

  // ── White transparent logos (for dark hero backgrounds) ──────────────────────
  belmondBelliniClubWhite:    m('/assets/supplier logos/white transparent/belmond-bellini_club.png'),
  dorchesterDiamondClubWhite: m('/assets/supplier logos/white transparent/dorchester-logo-white.png'),
  fourSeasonsPreferredWhite:  m('/assets/supplier logos/white transparent/FS_preferred-600.png'),
  hyattPriveTransparent:      m('/assets/supplier logos/white transparent/HyattPrive_white-transparent.png'),
  mandarinFanClubWhite:       m('/assets/supplier logos/white transparent/mandarin-oriental-fan-club-Mandarin-white-600.png'),
  peninsulaPenClubWhite:      m('/assets/supplier logos/white transparent/Peninsula_PenClub-white-600.png'),
  ritzCarltonStarsWhite:      m('/assets/supplier logos/white transparent/ritz-carlton-stars-white.png'),
  roccoForteWhite:            m('/assets/supplier logos/white transparent/Rocco_Forte-White-600.png'),
  rosewoodEliteWhite:         m('/assets/supplier logos/white transparent/rosewood-elite-white.png'),
  shangriLaLuxuryCircleWhite: m('/assets/supplier logos/white transparent/ShangriLa-white-600.png'),
  kempinskiClub1897White:     m('/assets/supplier logos/white transparent/Kempinski-Club1897-white-600.png'),
  oetkerPearlWhite:           m('/assets/supplier logos/white transparent/oetker-pearl-white-600.png'),
  amanWhite:                  m('/assets/supplier logos/white transparent/Aman-white-600.png'),
  aubergeResortsWhite:        m('/assets/supplier logos/white transparent/auberge-logo-white-600.png'),
  comoHotelsWhite:            m('/assets/supplier logos/white transparent/como-hotels-white.png'),
  oneAndOnlyWhite:            m('/assets/supplier logos/white transparent/one&only-white-600.png'),
  accorHeraWhite:             m('/assets/supplier logos/white transparent/accor-hera-white.png'),
  marriottLuminousWhite:      m('/assets/supplier logos/white transparent/marriott-stars_luminous.png'),
  leadingHotelsWhite:         m('/assets/supplier logos/white transparent/leading_hotels-white-600.png'),
  jumeirahWhite:              m('/assets/supplier logos/white transparent/jumeirah-passport-logo-white-600.png'),
  sixSensesWhite:             m('/assets/supplier logos/white transparent/SixSenses-logo-white-600.png'),
  montageWhite:               m('/assets/supplier logos/white transparent/montage-white-600.png'),
  coutureWhite:               m('/assets/supplier logos/white transparent/couture-logo-white-600.png'),
...
export const SUPPLIER_LOGOS = {
  leadingHotelsBlack:   m('/media/suppliers/logos/leading-hotels-black-600.png'),
  leadingHotelsWhite:   m('/media/suppliers/logos/leading_hotels-Logo.png'),
  colletteBlack:        m('/media/suppliers/logos/collette-black.png'),
  colletteWhite:        m('/media/suppliers/logos/collette-white.png'),
  exploraBlack:         m('/media/suppliers/logos/explora-black.png'),
  pureGermanyBlack:     m('/media/suppliers/logos/pure-germany-black.png'),
