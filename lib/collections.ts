...
const MOCK_PARTNERS: FeaturedPartner[] = [
  { id: '1',  name: 'Regent Seven Seas',           slug: 'regent-seven-seas',       logo_url: '/assets/supplier logos/black transparent/cruise/regent-black-600.png',                                  category: 'cruise', is_preferred: true,  sort_order: 1 },
  { id: '2',  name: 'Silversea Cruises',            slug: 'silversea',               logo_url: '/assets/supplier logos/jpg/Silversea-Logo.png',                                       category: 'cruise', is_preferred: true,  sort_order: 2 },
  ...
  { id: '4',  name: 'Oceania Cruises',              slug: 'oceania',                 logo_url: '/media/cruises/oceania/oceania-cruises-logo-black-600.png',                           category: 'cruise', is_preferred: true,  sort_order: 4 },
  { id: '5',  name: 'Four Seasons',                 slug: 'four-seasons-partner',    logo_url: '/media/hotel-programs/logos/four-seasons-preferred-partner.png',                      category: 'hotel',  is_preferred: true,  sort_order: 5 },
  { id: '6',  name: 'Aman',                         slug: 'aman-partner',            logo_url: '/media/hotel-programs/logos/aman.png',                                               category: 'hotel',  is_preferred: true,  sort_order: 6 },
  { id: '7',  name: 'Belmond Bellini Club',         slug: 'belmond-bellini-club',    logo_url: '/media/hotel-programs/logos/belmond-bellini-club.png',                                category: 'hotel',  is_preferred: true,  sort_order: 7 },
  { id: '8',  name: 'Mandarin Oriental Fan Club',   slug: 'mandarin-fan-club',       logo_url: '/media/hotel-programs/logos/mandarin-oriental-fan-club.png',                         category: 'hotel',  is_preferred: true,  sort_order: 8 },
  { id: '9',  name: 'Rosewood Elite',               slug: 'rosewood-elite',          logo_url: '/media/hotel-programs/logos/rosewood-elite.png',                                     category: 'hotel',  is_preferred: true,  sort_order: 9 },
  { id: '10', name: 'Hyatt Privé',                  slug: 'hyatt-prive',             logo_url: '/media/hotel-programs/logos/hyatt-prive.png',                                        category: 'hotel',  is_preferred: true,  sort_order: 10 },
  { id: '11', name: 'Peninsula Pen Club',           slug: 'peninsula-pen-club',      logo_url: '/media/hotel-programs/logos/peninsula-pen-club.png',                                 category: 'hotel',  is_preferred: true,  sort_order: 11 },
  { id: '12', name: 'Dorchester Diamond Club',      slug: 'dorchester-diamond-club', logo_url: '/media/hotel-programs/logos/dorchester-diamond-club.png',                            category: 'hotel',  is_preferred: true,  sort_order: 12 },
]
