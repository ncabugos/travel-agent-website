...
const MOCK_PROPERTIES: PropertyDestination[] = [
  ...
  { id: '4', name: 'Rosewood Miramar Beach', location: 'Montecito, California', description: 'A coastal sanctuary on storied Miramar Beach.', image_gallery: ['/media/hotel-programs/rosewood/rosewood-hero.jpg'], booking_link: null, is_featured: true, sort_order: 4 },
  { id: '5', name: 'Park Hyatt Sydney',      location: 'Sydney, Australia',   description: 'Harbourfront luxury with Opera House views.', image_gallery: ['/media/hotel-programs/hyatt/hyatt-hero.jpg'], booking_link: null, is_featured: true, sort_order: 5 },
  { id: '6', name: 'Mandarin Oriental Bangkok', location: 'Bangkok, Thailand', description: 'The legendary riverside icon since 1876.', image_gallery: ['/media/hotel-programs/mandarin-oriental/mandarin-hero.jpg'], booking_link: null, is_featured: true, sort_order: 6 },
]
