...
export const DEMO_T3_AGENT: MockAgent = {
  ...
  youtube_url: undefined,
  tiktok_url: undefined,
  website_url: 'https://meridiantravel.com',
  custom_domain: null,
  avatar_url: null,
  bio: 'A former hotelier turned advisor, Eleanor founded Meridian Travel after two decades inside luxury hospitality — most recently as guest experience director at one of Europe\'s most celebrated private-island resorts. Her relationships span three generations of the industry, from general managers and head butlers to head chefs and front-of-house teams. The result is the kind of access that no algorithm can replicate: the suite that was never listed, the table no one else can book, the guide who usually only works privately for a single family.',
  travel_specialties: [
    'Luxury',
    'Honeymoons & Romance',
    'Wellness & Spa',
