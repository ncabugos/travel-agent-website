...
const MOCK_CRUISE_LINES: CruiseLine[] = [
  ...
  // ── Ultra-Luxury Ocean ──────────────────────────────────────────────────────
  {
    ...
    ships: [
      ...
      { name: 'Seven Seas Grandeur', description: 'Newest fleet addition, launched 2023.' /* image dropped: the prior asset was a mislabeled non-Regent ship */ },
  ...
  // ── Expedition ──────────────────────────────────────────────────────────────
  {
    ...
    destinations: [
      { name: 'Antarctica & the North Pole', blurb: 'The remotest places on earth — Antarctica, the high Arctic, and the geographic North Pole — reached aboard Le Commandant Charcot, the only luxury icebreaker built to carry you there.', image_url: '/media/cruises/ponant/ponant-charcot.png' },
      { name: 'Greenland & the High Arctic', blurb: 'Aurora over the ice, Inuit villages, and fjords few will ever see — the far north explored with naturalists and Zodiacs from an intimate ship.', image_url: '/media/cruises/ponant/ponant-dest-greenland.png' },
      { name: 'The Kimberley', blurb: 'Ancient red gorges and tidal waterfalls along Australia\'s wild northwest, anchored each night beneath a vast and empty sky.', image_url: '/media/cruises/ponant/ponant-dest-kimberley.png' },
    ],
    experiences: [
      { title: 'French Art de Vivre', blurb: 'Gallic gastronomy, an Alain Ducasse partnership at sea, and unhurried evenings at the bar — the French way of luxury, carried to the ends of the earth.', image_url: '/media/cruises/ponant/ponant-exp-restaurant.png' },
      { title: 'Decks at the Water\'s Edge', blurb: 'Private terraces, a heated pool, and an outdoor whirlpool facing the wake — the ship\'s open decks designed for the long polar day or the warm tropical evening.', image_url: '/media/cruises/ponant/ponant-exp-suite.png' },
      { title: 'Wellness at Sea', blurb: 'A spa, sauna, and ocean-facing treatment spaces — restoration between Zodiac landings, with the sea always in view.', image_url: '/media/cruises/ponant/ponant-exp-spa.png' },
    ],
    sample_journeys: [
    ...
    ships: [
      { name: 'Le Commandant Charcot', description: 'The world\'s only luxury hybrid LNG-electric polar icebreaker — reaching the geographic North Pole and the far reaches of Antarctica.', image: '/media/cruises/ponant/ponant-charcot.png' },
      { name: 'Le Boréal', description: 'A Sistership — intimate expedition luxury for around 200 guests, at home from the poles to the tropics.', image: '/media/cruises/ponant/ponant-boreal.jpg' },
      { name: 'Le Soléal', description: 'A Sistership, sailing the world\'s wildest coastlines with French elegance and an expedition spirit.', image: '/media/cruises/ponant/ponant-soleal.jpg' },
      { name: 'Le Jacques-Cartier', description: 'A PONANT Explorer — around 180 guests, with the underwater Blue Eye lounge below the waterline.', image: '/media/cruises/ponant/ponant-jacques-cartier.png' },
      { name: 'Le Lapérouse', description: 'The first PONANT Explorer — compact, refined, and built for the world\'s remoter shores.', image: '/media/cruises/ponant/ponant-laperouse.png' },
      { name: 'Le Ponant', description: 'The original three-masted sailing yacht — just 16 staterooms under sail.', image: '/media/cruises/ponant/ponant-le-ponant-yacht.png' },
      { name: 'Spirit of Ponant', description: 'An intimate sailing yacht for the most private of voyages.', image: '/media/cruises/ponant/ponant-spirit.png' },
    ],
    slider_images: [
      '/media/cruises/ponant/ponant-charcot.png',
      '/media/cruises/ponant/ponant-le-ponant-yacht.png',
      '/media/cruises/ponant/ponant-soleal.jpg',
      '/media/cruises/ponant/ponant-dest-greenland.png',
      '/media/cruises/ponant/ponant-jacques-cartier.png',
      '/media/cruises/ponant/ponant-exp-spa.png',
    ],
    sort_order: 12,
  },
  {
  ...
  },
  {
    ...
    ships: [
      { name: 'Viking Polaris', description: 'Purpose-built expedition ship, 378 guests, polar regions.', image: '/media/cruises/viking/viking-polaris-antarctica.webp' },
      { name: 'Viking Vela', image: '/media/cruises/viking/viking-vela.jpg', description: 'New ocean ship, 998 guests, 2024.' },
      { name: 'Viking Vesta', description: 'Newest ocean ship, ~998 guests — delivered 2025.', image: '/media/cruises/viking/viking-vesta-geiranger.jpg' },
      { name: 'Viking Mira', description: 'Ocean ship — debuts 2026.', image: '/media/cruises/viking/viking-mira-south-pacific.webp' },
