...
export default function AgentRegisterPage() {
  ...
  async function handleRegister(e: FormEvent) {
    ...
    if (authError) {
      ...
      setMessage("Check your email — your account link is on its way.")
    }
    setLoading(false)
  }
  ...
  return (
    <AuthLayout
      headline="Build the Website Your Practice Deserves"
      subline="Create your Elite Advisor Hub account. A custom-branded Virtuoso-grade site, the supplier catalog, and a journal module — live in days."
    >
      <div style={{ textAlign: 'center', marginBottom: '28px' }}>
        ...
        <p style={{ margin: '8px 0 0', fontSize: '14px', color: '#6b7280' }}>
          Enter your email — we&apos;ll send a secure link to get you started. No password required.
        </p>
      </div>
