...
/**
 * Minimal, linear SVG icons for the dashboard.
 * All icons are 20×20 with stroke-based rendering.
 */

const iconStyle = { width: 20, height: 20, fill: 'none', stroke: 'currentColor', strokeWidth: 1.5, strokeLinecap: 'round' as const, strokeLinejoin: 'round' as const }
